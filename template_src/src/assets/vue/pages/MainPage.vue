<template>
    <f7-page>
        <f7-navbar>
            <div class="title">Framework7-Vue-Typescript</div>
            <f7-nav-right>
        ...
        <f7-block inner>
            <p>Cordova - Framework7 - Vue - Typescript</p>
        </f7-block>
        <f7-block-title class="searchbar-found">Links</f7-block-title>
        <f7-list class="components-list searchbar-found">
            <f7-list-item link="/aboutPage/" title="About" panel-close>
                <f7-icon slot="media" ios="f7:info" md="material:info"></f7-icon>
            </f7-list-item>
            <f7-list-item link="/formPage/" title="Form" panel-close>
                <f7-icon slot="media" material='home'></f7-icon>
            </f7-list-item>
            <f7-list-item link="/dynamicRoutePage/blog/11/post/23/" title="Dynamic Route" panel-close>
            </f7-list-item>
            <f7-list-item link="/vuex/" title="Vuex" panel-close>
                <f7-icon material='battery_std'></f7-icon>
            </f7-list-item>
        </f7-list>
        ...
        <f7-list class="searchbar-hide-on-search">
            ...
            <f7-list-item title="Color Themes" link="/colorThemePage/"></f7-list-item>
